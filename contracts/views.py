...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def contracts_mock(request):
    """Endpoint mock de contratos con dos contratos estáticos (HU24)"""
    today = timezone.now().date()
    data = {
        ...
        'contracts': [
            {
                ...
                'title': 'Contrato de venta vivienda',
                'contract_type': 'sale',
                'status': 'active',
                'priority': 'high',
                'client_name': 'Carlos López',
                'property_address': 'Calle 123, Bogotá',
                'property_type': 'Casa',
            ...
            {
                'id': 'mock-C-002',
                'contract_number': 'MOCK-002',
                'title': 'Contrato de arriendo oficina',
                'contract_type': 'rent',
                'status': 'draft',
                'priority': 'medium',
                'client_name': 'Inversiones ABC',
                'property_address': 'Av. Central 45, Lima',
