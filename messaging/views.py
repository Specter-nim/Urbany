...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def messaging_mock(request):
    """Endpoint mock de mensajería con lista de mensajes ficticios (HU28)"""
    data = {
        'generated_at': timezone.now().isoformat(),
        'messages': [
            {
                'id': 'mock-M-001',
                'conversation_id': 'mock-C-CHAT',
                'message_type': 'text',
                'content': 'Hola equipo, ¿confirmamos la reunión de hoy?',
                'sender': {
                    'id': 'user-101',
                    'name': 'María Pérez'
                },
            ...
            },
            {
                ...
                'conversation_id': 'mock-C-CHAT',
                'message_type': 'text',
                'content': 'Sí, a las 16:00. Enviaré la invitación.',
                'sender': {
                    'id': 'user-102',
                    'name': 'Carlos López'
                },
                'is_read': True,
                'created_at': (timezone.now() - timedelta(minutes=25)).isoformat()
            },
            {
                'id': 'mock-M-003',
                'conversation_id': 'mock-C-VENTAS',
                'message_type': 'text',
                'content': 'Cliente confirmó interés en la propiedad del Centro.',
                'sender': {
                    'id': 'user-103',
                    'name': 'Ana Gómez'
                },
            ...
            {
                'id': 'mock-M-004',
                'conversation_id': 'mock-C-SOPORTE',
                'message_type': 'text',
                'content': 'Soporte: ticket #4523 resuelto. Verificar documentación.',
                'sender': {
                    'id': 'user-104',
                    'name': 'Soporte Urbany'
                },
