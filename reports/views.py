...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def reports_mock(request):
    """Endpoint mock de reportes con gráficos estáticos (HU13)"""
    data = {
        'generated_at': timezone.now().isoformat(),
        'reports': [
            {
                'id': 'mock-1',
                'name': 'Reporte Gerencial - Ventas',
                'summary': {
                    'total_records': 1200,
                    'period': '2024-Q1'
                },
                'charts': [
                    ...
                    },
                    {
                        ...
                        'datasets': [
                            {
                                'label': 'Ingresos',
                                'data': [15000, 23000, 18000, 27000, 22000, 35000],
                                'borderColor': '#4BC0C0'
                            }
                        ]
                    },
